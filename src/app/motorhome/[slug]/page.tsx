import { getPostBySlug, getAllPosts, getDefaultTagByCluster } from "@/lib/posts";
        ...
        "@graph": [
            {
                ...
                ...(post.rating && {
                    ...
                    "offers": {
                        ...
                        "url": `https://guiadegeladeira.com.br/motorhome/${slug}`,
            ...
            ...(post.faq && post.faq.length > 0 ? [{
                "@type": "FAQPage",
                "@id": `https://guiadegeladeira.com.br/motorhome/${slug}#faq`,
