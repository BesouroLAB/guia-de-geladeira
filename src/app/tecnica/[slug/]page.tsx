            ...
            <article className="container mx-auto px-4 max-w-2xl py-8">
                ...
                <header className="mb-10 relative">
                    <div className="mb-4 flex flex-wrap items-center gap-4">
                        <span className="bg-amber-100 text-amber-800 text-[10px] font-black px-2 py-1 rounded uppercase tracking-[0.2em] border border-amber-200 flex items-center gap-2">
                            <Lightbulb className="w-3 h-3" /> Inteligência Elétrica
                        </span>
                    ...
                    <div className="flex items-center gap-3 p-3 bg-slate-100 rounded-lg border border-slate-200 inset-metal">
                        ...
                        <div>
                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-none mb-1">Escrito por</p>
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-slate-400 text-xs uppercase tracking-widest mt-1">Garantia de segurança e eficiência</p>
                            </div>
                        </div>
